...
// Function Widget_CompassObjectResource.Widget_CompassObjectResource_C.GetAngleFromCompassCenter
// ()
// Parameters:
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float UWidget_CompassObjectResource_C::GetAngleFromCompassCenter()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_CompassObjectResource.Widget_CompassObjectResource_C.GetAngleFromCompassCenter");

	UWidget_CompassObjectResource_C_GetAngleFromCompassCenter_Params params;
