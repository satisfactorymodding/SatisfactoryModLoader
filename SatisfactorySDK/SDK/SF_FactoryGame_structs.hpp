...
{
	int                                                MeshIconIndex;                                            // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	class FString                                      SignText;                                                 // 0x0008(0x0010) (BlueprintVisible, ZeroConstructor, SaveGame)
	float                                              IconRotSpeed;                                             // 0x0018(0x0004) (BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              TextRotSpeed;                                             // 0x001C(0x0004) (BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              IconMeshScale;                                            // 0x0020(0x0004) (BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              TextMeshScale;                                            // 0x0024(0x0004) (BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
};
...
// ScriptStruct FactoryGame.SignMeshIcon
// 0x0030
struct FSignMeshIcon
{
	class UTexture2D*                                  IconTexture;                                              // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UStaticMesh*                                 StaticMesh;                                               // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FText                                       DisplayName;                                              // 0x0010(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	int                                                SortPriority;                                             // 0x0028(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
