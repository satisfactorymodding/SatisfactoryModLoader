...
UOnlineAsyncOperation* UCommonUserSubsystem::CreateAuthenticationSequence(FPlatformUserId PlatformUserId, FName SequenceName, bool bSuppressErrors){ return nullptr; }
void UCommonUserSubsystem::EnqueueAuthenticationSequence(UOnlineAsyncOperation* InAsyncOp){ }
void UCommonUserSubsystem::SetPendingAuthenticationSequence(UOnlineAsyncOperation* InAsyncOp){ }
void UCommonUserSubsystem::ExecutePendingAuthenticationSequence(){ }
void UCommonUserSubsystem::CancelPendingAuthenticationSequence(){ }
ULocalUserInfo* UCommonUserSubsystem::GetUserInfoForAccountId(const UE::Online::FAccountId AccountId) const{ return nullptr; }
FString UCommonUserSubsystem::GetAccountIdStringForUserBackend(UOnlineUserBackendLink* BackendLink){ return FString(); }
...
FUniqueNetIdPtr UCommonUserSubsystem::ConvertAccountIdToNetId(UE::Online::FAccountId accountId) { return nullptr; }
void UCommonUserSubsystem::ResetAuthenticationQueue_Unsafe(){ }
UOnlineIntegrationSubsystem* UCommonUserSubsystem::GetOnlineIntegration() const{ return nullptr; }
