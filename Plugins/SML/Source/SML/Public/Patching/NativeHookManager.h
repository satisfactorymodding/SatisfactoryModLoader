...
public:
	...
	static void* RegisterHookFunction(const FString& DebugSymbolName, const FMemberFunctionPointer& MemberFunctionPointer, void* SampleObjectInstance, void* HookFunctionPointer, void** OutTrampolineFunction);
