...
AFGBuildableRailroadTrack::AFGBuildableRailroadTrack() : Super() {
	...
	this->mSplineInstanceStartDataIndex = 15;
...
float AFGBuildableRailroadTrack::GetNetSignificanceRange_Implementation() const{ return IFGNetSignificanceInterface::GetNetSignificanceRange_Implementation(); }
...
TArray<FVector> AFGBuildableRailroadTrack::GetPointsAlongTrack(float maxDistance, float startOffset, float endOffset) const{ return TArray<FVector>(); }
FBox AFGBuildableRailroadTrack::CalculateBounds() const{ return Super::CalculateBounds(); }
