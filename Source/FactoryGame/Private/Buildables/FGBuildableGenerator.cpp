...
void UFGGeneratorClipboardRCO::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
	...
	DOREPLIFETIME(UFGGeneratorClipboardRCO, mForceNetField_UFGGeneratorClipboardRCO);
}
...
bool AFGBuildableGenerator::PasteSettings_Implementation(UFGFactoryClipboardSettings* factoryClipboard, class AFGPlayerController* player){ return bool(); }
