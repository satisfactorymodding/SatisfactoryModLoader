...
float AFGBuildablePipeBase::GetSignificanceRange_Implementation() const{ return IFGSignificanceInterface::GetSignificanceRange_Implementation(); }
...
float AFGBuildablePipeBase::GetNetSignificanceRange_Implementation() const{ return IFGNetSignificanceInterface::GetNetSignificanceRange_Implementation(); }
...
TArray<FInstanceData> AFGBuildablePipeBase::SetupAbstractInstances(const FFactoryCustomizationData& CustomizationData) const{ return TArray<FInstanceData>(); }
...
FBox AFGBuildablePipeBase::CalculateBounds() const{ return Super::CalculateBounds(); }
