...
AFGPlayerState::AFGPlayerState() : Super() {
	...
	this->mSlotNum = -1;
	this->mPlayerColorData.PingColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mPlayerColorData.NametagColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	...
	this->mPlayerCustomizationData.PrimaryColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mPlayerCustomizationData.SecondaryColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mPlayerCustomizationData.DetailColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	...
	this->mPhotoModeComponent = CreateDefaultSubobject<UFGPhotoModeComponent>(TEXT("PhotoModeComponent"));
	this->mNumArmSlots = 1;
...
bool AFGPlayerState::ShouldTrackNewRecipe(const TSubclassOf<UFGRecipe>& recipe) const{ return bool(); }
...
bool AFGPlayerState::IsPlayerSpecificSchematicPurchased(const TSubclassOf<UFGSchematic>& schematic) const{ return bool(); }
void AFGPlayerState::Internal_AddPurchasedPlayerSpecificSchematic(const TSubclassOf<UFGSchematic>& schematic){  }
...
void AFGPlayerState::Client_NotifyGivenAccessToSchematics_Implementation(const TArray<TSubclassOf<UFGSchematic>>& schematics, ESchematicUnlockFlags unlockFlags){  }
...
void AFGPlayerState::Server_SetMaxDismantleStacksInInventory_Implementation(int32 newMaxDismantleStacksInInventory){  }
