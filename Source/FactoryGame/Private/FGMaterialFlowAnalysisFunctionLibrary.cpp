...
struct FMaterialFlowNode* FMaterialFlowGraph::CreateNodeFromRecipe(const UObject* worldContext, TSubclassOf<UFGRecipe> recipe, int32 depth){ return nullptr; }
...
FMaterialFlowGraph UFGMaterialFlowAnalysisFunctionLibrary::PerformMaterialFlowAnalysis(const UObject* worldContext, TArray<TSubclassOf<UFGRecipe>> recipes, const TArray<TSubclassOf<UFGRecipe>>& availableRecipes){ return FMaterialFlowGraph(); }
