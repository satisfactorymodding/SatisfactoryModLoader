...
#if WITH_EDITOR
EDataValidationResult UFGCalendarRewards::IsDataValid(FDataValidationContext& Context) const{ return EDataValidationResult::Valid; }
#endif 
...
TArray<class UFGUnlock*> UFGCalendarRewards::GetSecondarySlotUnlocks(TSubclassOf<UFGCalendarRewards> inClass){ return TArray<class UFGUnlock*>(); }
...
UFGUnlock* UFGCalendarRewards::GetSecondarySlotUnlock(TSubclassOf<UFGCalendarRewards> inClass, int32 index){ return nullptr; }
