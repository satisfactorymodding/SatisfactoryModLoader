...
#endif 
AFGHUD::AFGHUD() : Super() {
	this->mDefaultCrosshair = CreateDefaultSubobject<UTexture2D>(TEXT("FirstPersonCrosshair"));
	this->mPickupCrosshair = this->mDefaultCrosshair;
	this->mVehicleCrosshair = this->mDefaultCrosshair;
	this->mWeaponCrosshair = this->mDefaultCrosshair;
	this->mWorkbenchCrosshair = this->mDefaultCrosshair;
	this->mGeneralCrosshair = this->mDefaultCrosshair;
}
