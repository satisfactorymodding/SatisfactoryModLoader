...
bool UFGPipeConnectionComponentBase::CanConnectTo(const UFGPipeConnectionComponentBase* otherConnection) const{ return bool(); }
...
UFGPipeConnectionComponentBase* UFGPipeConnectionComponentBase::FindCompatibleOverlappingConnection( UFGPipeConnectionComponentBase* component, const FVector& location, const AActor* priorityActor, float radius, const TSet< UFGPipeConnectionComponentBase* >& ignoredConnections){ return nullptr; }
UFGPipeConnectionComponentBase* UFGPipeConnectionComponentBase::FindOverlappingConnection( UFGPipeConnectionComponentBase* component, const FVector& location, const AActor* priorityActor, float radius, const TSet< UFGPipeConnectionComponentBase* >& ignoredConnections){ return nullptr; }
...
void UFGPipeConnectionComponent::OnFluidDescriptorUpdated_GameThread(){ }
