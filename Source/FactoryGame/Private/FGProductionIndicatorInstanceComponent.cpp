...
UFGProductionIndicatorInstanceComponent::UFGProductionIndicatorInstanceComponent() : Super() {
	this->mStateNoneData.mColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mStateActiveData.mColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mStateActiveWithCrystalData.mColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mStateErrorData.mColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
	this->mStateStandbyData.mColor = FLinearColor(0.0, 0.0, 0.0, 1.0);
