...
void FGBlueprintOpenFactoryConnectionManager::OnBridgeConstructed(const OpenConnectionState& state, AFGBuildable* bridgeBuildable){ }
...
void FGBlueprintOpenPipeConnectionManager::OnBridgeConstructed(const OpenConnectionState& state, AFGBuildable* bridgeBuildable){ }
...
void FGBlueprintOpenRailroadConnectionManager::OnBridgeConstructed(const OpenConnectionState& state, AFGBuildable* bridgeBuildable){ }
