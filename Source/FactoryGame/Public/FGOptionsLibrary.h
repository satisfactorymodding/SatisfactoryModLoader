...
public:
	 ...
	 */
	static void GatherUserSettings( IFGOptionInterface* manager, TMap< FString, TObjectPtr<UFGUserSettingApplyType> >& out_userSettings, UClass* managerAvailabilityOverride = nullptr, bool bDedicatedServerRelevantOnly = false );
	 ...
	 */
	static TArray<FUserSettingCategoryMapping> GetCategorizedUserSettingsWidgets( ESettingVisiblityDisqualifier visibilityDisqualifiers, UUserWidget* owningWidget, TScriptInterface<class IFGOptionInterface> optionInterface, TMap< FString, TObjectPtr<UFGUserSettingApplyType> > userSettings );
	 ...
	 * @param userSettings The setting to create the option row from
	 */
	static TArray<FUserSettingCategoryMapping> GetCategorizedUserSettingsWidgets( UObject* worldContext, UUserWidget* owningWidget, TScriptInterface<class IFGOptionInterface> optionInterface, TMap< FString, TObjectPtr<UFGUserSettingApplyType> > userSettings );

	/** Returns the user setting data asset for the given setting name
	 * @param SettingName The name of the setting to get the data asset for
	 */
	static TObjectPtr<UFGUserSetting> GetUserSettingDataAsset( const FString& SettingName);
	 ...
	 */
	static UFGDynamicOptionsRow* SetupUserSetting( UUserWidget* owningWidget, class UFGUserSetting* userSetting, TScriptInterface< class IFGOptionInterface > optionInterface, FSettingsWidgetLocationDescriptor widgetLocator );
