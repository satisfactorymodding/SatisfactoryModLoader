...
struct FSignRPC_Data
{
	...
	UPROPERTY()
	TArray< TObjectPtr<AFGBuildableWidgetSign> > Signs;

	// When receiving on client this map will be generated by NetSerialize
	UPROPERTY( NotReplicated )
	TMap< TObjectPtr<AFGBuildableWidgetSign>, FPrefabSignData > SignToDataMap;
...
public:
	...
	UPROPERTY()
	TObjectPtr<AFGBuildableWidgetSign> Sign;
...
struct FACTORYGAME_API FMappedSignData
{
	...
	void RemoveOwner( AFGBuildableWidgetSign* RemovedSign )
	{
		...
		if(Index != INDEX_NONE)
		{
			Owners.RemoveAt( Index,1, EAllowShrinking::Yes );
		}
	}
...
private:
	...
	/// Pixel Sign Members
	UPROPERTY()
	TObjectPtr<AActor> mSignPixelInstanceActor;

	UPROPERTY()
	TMap< int32, TObjectPtr<UFGSignPixelInstanceManager> > mPixelInstanceManagerMap;
