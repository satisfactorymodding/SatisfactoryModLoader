...
class FACTORYDEDICATEDCLIENT_API UFGClientStateRequester : public UFGClientRequestBase
{
	GENERATED_BODY()
public:
	UFUNCTION( FGServerRequest, FGServerRequestPrivilegeLevel = "Client", FGSuppressClientAPIErrorPopup = "All" )
	...
	UFUNCTION( FGServerRequest, FGServerRequestPrivilegeLevel = "NotAuthenticated", FGSuppressClientAPIErrorPopup = "All" )
