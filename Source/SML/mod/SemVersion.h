...
public:
	...
	bool ParseVersion(const FString& String, FString& OutFailureReason);
...
public:
	 ...
	 */
	bool ParseVersionComparator(const FString& String, FString& OutFailureReason);
...
public:
	 ...
	 */
	bool ParseVersionCollection(const FString& String, FString& OutFailureReason);
...
public:
	 ...
	 *  @param OutFailureReason reason for parsing failure if result is false
	 *  @return true when parsing succeeded, false otherwise
	 */
	bool ParseVersionRange(const FString& String, FString& OutFailureReason);
