...
public:
	...
	virtual bool ReclaimCurrentServerSocket(TSharedPtr<FSocket>& ServerSocket); // TODO: MODDING ask Arch override;
	// End UIpNetDriver interface
private:
	static FUniqueSocket TryReclaimNativeSocket( FSocket* Socket );
